    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              <h2 style="font-family: vandana;" class="mb-0">Admin Registration</h2>
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a style="font-family: vandana; margin-left: 100px" href="admin_login.php">Login</a>
                        </div>
