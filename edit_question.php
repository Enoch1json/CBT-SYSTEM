      ...
      <form method="post" id="question_form"
          <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 style="font-family: vandana" class="modal-title" id="question_modal_title">Edit Question with text in  <span style="font-family: vandana;font-size: 20px;color: blue"><?php echo $exam_category;   ?></span></h4>
            ...
            <div class="modal-body">
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="question" id="question" autocomplete="off" class="form-control" value="<?php echo $question; ?>" />
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="option1" id="option1" autocomplete="off" class="form-control" value="<?php echo $option1 ?>" />
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="option2" id="option2" autocomplete="off" class="form-control" value="<?php echo $option2 ?>" /> 
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="option3" id="option3" autocomplete="off" class="form-control" value="<?php echo $option3 ?>" /> 
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="option4" id="option4" autocomplete="off" class="form-control" value="<?php echo $option4 ?>" /> 
                      </div>
                  </div>
                </div>
                <div class="form-group">
...
if (question == "" || option1 == "" || option2 == "" || option3 == "" || option4 == "" || answer == "") {
  ...
  $("#message").hide();
  $.ajax({
    url : "update_question_engine.php",
    method : "POST",
    data : {
         "update_question" : 1,
         "question" : question,
