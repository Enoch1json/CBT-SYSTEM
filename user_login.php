    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              <h2 class="mb-0" style="font-weight: bold;">Student Login</h2>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                          <div id="feedback" style="font-size: 22px; color: rgb(255,0,0); font-family: vandana "></div>
                            <label for="username" style="font-weight: bold;">Exam Number</label>
                            <input type="text" id="username" class="form-control form-control-lg">
                            <span id="username_feedback"></span>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword" style="font-weight: bold;">Password</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input id="login" type="submit" value="Access Exam" class="btn btn-primary btn-lg px-5" style="font-weight: bold;">
...
function username1(username){
        if(username == ""){
          $("#username_feedback").text("**Please enter Exam Number").css("color","rgb(255,0,0)").hide().fadeIn(1000);
          $("#username").focus();
          return false;
        }else{
